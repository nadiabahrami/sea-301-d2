...
articleView.handleAuthorFilter = function() {
  ...
  $('#author-filter').on('change', function() {
    if ($(this).val()) {
        ...
        // $yes.show();
        // if($(this).val()===(articl)
        $('article').filter("[data-author = '"+name+ "']").show();
        // data('author' ).show();
         // DONETODO: If the select box was changed to an option that has a value, we need to hide all the articles,
      //       and then show just the ones that match for the author that was selected.
      //       Use an "attribute selector" to find those articles, and fade them in for the reader.
      console.log('three');
    } else {
      // DONETODO: If the select box was changed to an option that is blank, we should
...
articleView.handleCategoryFilter = function() {
  $('#category-filter').on('change', function() {
    if ($(this).val()) {
        ...
        // $yes.show();
        // if($(this).val()===(articl)
        $('article').filter("[data-category = '"+name+ "']").show();
        console.log('three');
  ...
  // DONETODO: Just like we do for #author-filter above, we should handle change events on the #category-filter element.
...
articleView.setTeasers = function() {
  ...
  // DONETODO: Add an event handler to reveal all the hidden elements,
...
// DONETODO: Call all of the above functions, once we are sure the DOM is ready.
